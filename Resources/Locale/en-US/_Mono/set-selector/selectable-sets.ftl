selectable-set-rd-hardsuit-name = RD Hardsuit
selectable-set-rd-hardsuit-desc =
    A hardsuit for heavy research. Uses NVGs instead of a headlamp. Fits in your bag too.
