...
nf-tips-dataset-91 = As a member of the PDV, use a voice mask to hide your true name when speaking over the Vanguard radio! If the TSFMC hears your voice over a stolen encryption key, things are unlikely to end well for you.
...
nf-tips-dataset-94 = The Overseer, Colonel or Grand Vizier can rename your shuttle! Usually it's enough to hand your ID and ask them to do it.
...
nf-tips-dataset-111 = Remember, Caelestinus Central has a 256m wide safe-zone. It's forbidden to steal from ships or ID's within that limit! Read the rules for more information.
...
nf-tips-dataset-115 = As a PDV rahkshan, you can exchange many TSF, wayward or monolithic items for data chits. Keep an eye out for the lock symbol indicating an item can be exchanged!
nf-tips-dataset-116 = Every shuttle console has an internal traffic intercom. Make sure to use it to contact the station before docking with Halcyon or Helios!
